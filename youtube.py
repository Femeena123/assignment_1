...
def Api_connect():
    Api_Id="AIzaSyB2yOdBtSANJg0HIdfkEfRSzIidqZWYeyA"
...
client=pymongo.MongoClient("mongodb+srv://Femeena:12345@cluster0.ipvzybr.mongodb.net/?retryWrites=true&w=majority")
...
def playlist_table():
    ...
    for index,row in df1.iterrows():
        insert_qyery='''insert into playlists(Playlist_Id,
                                              Title,
                                              Channel_Id,
                                              Channel_Name,
                                              PublishedAt,
...
def videos_table():
    ...
    creat_query='''create table if not exists videos(Channel_Name varchar(100),
                                                    Channel_Id varchar(100),
                                                    Video_Id_ varchar(30) primary key,
                                                    Title varchar(150),
                                                    Tags text,
    ...
    for index,row in df2.iterrows():
            insert_qyery='''insert into videos(Channel_Name,
                                                    Channel_Id,
                                                    Video_Id_,
                                                    Title,
                                                    Tags,
...
def comments_table():
    ...
    for index,row in df3.iterrows():
            insert_qyery='''insert into comments(Comment_Id,
                                                    Video_Id,
                                                    Comment_Text,
                                                    Comment_Author,
                                                    Comment_Published
...
question=st.selectbox("Select your question",("1. All the videos and the channel name",
                                              "2. Chennels with most number of videos",
                                              ...
                                              "9. Avrage duration of all videos in each channel",
...
if question=="1. All the videos and the channel name":
...
elif question=="2. Chennels with most number of videos":
    ...
    query7='''select channel_name as channelaname, views as totalviews from channels'''
    cursor.execute(query7)
    mydb.commit()
    t7=cursor.fetchall()
    df7=pd.DataFrame(t7,columns=["channel name","totalviewes"])
    st.write(df7)
...
elif question=="9. Avrage duration of all videos in each channel":
